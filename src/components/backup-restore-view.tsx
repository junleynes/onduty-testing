...
export default function BackupRestoreView() {
    ...
    const handleBackup = () => {
        startBackupTransition(async () => {
            ...
            // Decode base64 → binary → Blob — preserves ZIP binary integrity
        ...
        startMaintTransition(async () => {
            ...
            if (result.success) {
                ...
                toast({
                    ...
                    description: newState ? 'Only admins can now access the site.' : 'Site is now accessible to all users.',
                });
            } else {
        ...
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Manage database backups, restoration, and site maintenance.</p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Downloads a <code className="text-xs bg-muted px-1 rounded">.zip</code> containing{' '}
                        <code className="text-xs bg-muted px-1 rounded">local.db</code> and all uploaded files
                        (avatars, signatures, PDFs, report templates).
                    </CardDescription>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Replace the current database with a{' '}
                        <code className="text-xs bg-muted px-1 rounded">.zip</code> backup or a legacy{' '}
                        <code className="text-xs bg-muted px-1 rounded">.db</code> file.
                        The page reloads automatically after a successful restore.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                        <Construction className="h-4 w-4 text-amber-500" /> Maintenance Mode
                    </CardTitle>
                    <CardDescription>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Button size="sm" variant="outline" disabled={isMaintSaving} onClick={handleSaveMessage}>
                            {isMaintSaving && <Loader2 className="mr-2 h-3 w-3 animate-spin" />}
                            Save Message
                        </Button>
                    </div>
                </CardContent>

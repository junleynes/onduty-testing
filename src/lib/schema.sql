...
('member',  '["dashboard","my-schedule","my-tasks","schedule","onduty","time-off","allowance","team","org-chart","celebrations","holidays","faq","reports","report-wfh","avl-management","work-extensions"]')
